...
class Smoketree_Plugin {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'template_redirect', $plugin_public, 'redirect_my_account' );
	...
	private function register_ajax_handlers() {
		...
		$this->loader->add_action( 'wp_ajax_stsrc_set_demo_flag', $ajax_handler, 'set_demo_flag' );
		...
		$this->loader->add_action( 'wp_ajax_stsrc_preview_email_template', $ajax_handler, 'preview_email_template' );
		...
		$this->loader->add_action( 'wp_ajax_stsrc_save_banner', $ajax_handler, 'save_banner' );
		...
		$this->loader->add_action( 'wp_ajax_stsrc_reset_affiliate_code', $discount_ajax, 'reset_member_affiliate_code' );
