...
<head>
	...
	<title><?php echo esc_html__( 'New member registration', 'smoketree-plugin' ); ?></title>
	<style>
		...
		.email-header { background-color:#0f172a; padding:26px 24px; text-align:center; color:#ffffff; font-size:20px; font-weight:600; }
				...
				<table role="presentation" class="email-container" width="100%" cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td class="email-header">
							<?php echo esc_html__( 'New member registration submitted', 'smoketree-plugin' ); ?>
						</td>
					</tr>
					<tr>
						<td class="email-body">
							<h1><?php echo esc_html__( 'Please review the new account', 'smoketree-plugin' ); ?></h1>
							<p><?php echo esc_html__( 'A prospective member just completed registration. The details are listed below so you can verify payment and activation steps.', 'smoketree-plugin' ); ?></p>
							...
							<table role="presentation" class="data-table">
								<tbody>
									...
									<?php if ( ! empty( $status_label ) ) : ?>
										<tr>
											<th><?php echo esc_html__( 'Current status', 'smoketree-plugin' ); ?></th>
											<td><?php echo esc_html( ucfirst( $status_label ) ); ?></td>
										</tr>
									<?php endif; ?>
								</tbody>
							</table>

							<p><?php echo esc_html__( 'Log into the admin to confirm the registration details, verify payment, and activate the membership when ready.', 'smoketree-plugin' ); ?></p>

							<p style="text-align:center;">
								<a href="<?php echo esc_url( $member_admin_url ); ?>" class="btn"><?php echo esc_html__( 'Open member in admin', 'smoketree-plugin' ); ?></a>
							</p>
						</td>
					</tr>
					<tr>
...
<?php
/**
 * Notify Admin of Member Email Template
 *
 * Alerts admins about every new registration in real time.
 *
