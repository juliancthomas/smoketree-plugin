...
<head>
	...
	<title><?php echo esc_html__( 'Member Renewal Completed', 'smoketree-plugin' ); ?></title>
</head>
<body style="font-family: Arial, sans-serif; color: #1d2327; background: #f6f7f7; padding: 20px;">
	<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 620px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden;">
		<tr><td style="padding: 20px 24px; background: #0f172a; color: #ffffff;"><strong><?php echo esc_html__( 'Renewal Completed', 'smoketree-plugin' ); ?></strong></td></tr>
		<tr>
			<td style="padding: 24px;">
				<p><?php echo esc_html__( 'A member renewal has been completed successfully.', 'smoketree-plugin' ); ?></p>
				...
				<p><strong><?php echo esc_html__( 'Amount:', 'smoketree-plugin' ); ?></strong> <?php echo esc_html( '$' . number_format( (float) ( $total_amount ?? 0 ), 2 ) ); ?></p>
