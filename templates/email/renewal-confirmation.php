<?php
/**
 * Member renewal confirmation email template.
 *
...
<head>
	...
	<title><?php echo esc_html__( 'Renewal Confirmation', 'smoketree-plugin' ); ?></title>
</head>
<body style="font-family: Arial, sans-serif; color: #1d2327; background: #f6f7f7; padding: 20px;">
	<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 620px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden;">
		<tr><td style="padding: 20px 24px; background: #1f4d3a; color: #ffffff;"><strong><?php echo esc_html__( 'Membership Renewal Confirmed', 'smoketree-plugin' ); ?></strong></td></tr>
		<tr>
			<td style="padding: 24px;">
				<p><?php echo esc_html( sprintf( __( 'Hi %s,', 'smoketree-plugin' ), $member_name ) ); ?></p>
				<p><?php echo esc_html__( 'Thank you for renewing your Smoketree membership.', 'smoketree-plugin' ); ?></p>
