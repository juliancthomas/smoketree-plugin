					...
					<div class="stsrc-event-card__body">
						...
						<ul class="stsrc-event-card__meta">
							<li class="stsrc-event-card__meta-item">
								<svg class="stsrc-event-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
								<?php echo $date_display; ?>
							</li>
							<?php if ( $location ) : ?>
							<li class="stsrc-event-card__meta-item">
								<svg class="stsrc-event-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
								<?php echo esc_html( $location ); ?>
							</li>
							<?php endif; ?>
							<?php if ( $event_cost ) : ?>
							<li class="stsrc-event-card__meta-item">
								<svg class="stsrc-event-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
