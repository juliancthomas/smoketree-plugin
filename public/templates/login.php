...
<div class="stsrc-login-page">
	<div class="stsrc-container">
		<h1><?php echo esc_html__( 'Member Login', 'smoketree-plugin' ); ?></h1>
		...
		<form id="stsrc-login-form" class="stsrc-login-form" method="post">
			...
			<div class="stsrc-form-group">
				<label for="user_login"><?php echo esc_html__( 'Email Address', 'smoketree-plugin' ); ?></label>
				<input type="email" name="user_login" id="user_login" required autocomplete="email">
			</div>
			...
			<div class="stsrc-form-group">
				<button type="submit" class="stsrc-button stsrc-button-primary" id="stsrc-submit-login">
